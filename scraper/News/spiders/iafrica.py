...
class iafricaSpider(scrapy.Spider):
    name = "iafrica"
    
    def __init__(self, *a, **kw):
        super(iafricaSpider, self).__init__(*a, **kw)
    ...
    def yield_text_parse(self, response):
        ...
        text = ' '.join(response.css('div.td-post-content p::text').extract())
