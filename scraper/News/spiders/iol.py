...
class iolSpider(scrapy.Spider):
    ...
    def __init__(self, *a, **kw):
        super(iolSpider, self).__init__(*a, **kw)
        ...
        self.site = "www.iol.co.za/business-report"
    ...
    def yield_text_parse(self, response):
        ...
        date = response.css('meta[itemprop="dateModified"]::attr(content)').extract_first()
        text = ' '.join(response.css('div#article-more-body.articleBodyMore p::text').extract())
