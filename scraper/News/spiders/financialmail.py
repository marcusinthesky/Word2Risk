...
class financialmailSpider(scrapy.Spider):
    name = "financialmail"
    
    def __init__(self, *a, **kw):
        super(financialmailSpider, self).__init__(*a, **kw)
        ...
        self.site = "www.businesslive.co.za/fm/"
    ...
    def yield_text_parse(self, response):
        ...
        date = response.css('div.article-pub-date::text').extract_first()
        text = ' '.join(response.css('div.text p::text').extract())
