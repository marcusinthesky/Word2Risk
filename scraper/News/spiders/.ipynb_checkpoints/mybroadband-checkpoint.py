...
class mybroadbandSpider(scrapy.Spider):
    name = "mybroadband"
    
    def __init__(self, *a, **kw):
        super(mybroadbandSpider, self).__init__(*a, **kw)
        ...
        self.site = "https://mybroadband.co.za/news/"
    ...
    def yield_text_parse(self, response):
        ...
        date = response.css('span.post-date.updated::text').extract_first()
