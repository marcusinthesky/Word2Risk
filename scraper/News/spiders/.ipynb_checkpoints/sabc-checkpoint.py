...
class sabcSpider(scrapy.Spider):
    name = "sabc"
    
    def __init__(self, *a, **kw):
        super(sabcSpider, self).__init__(*a, **kw)
        ...
        self.site = "www.sabcnews.com/sabcnews/"
    ...
    def yield_text_parse(self, response):
        ...
        text = ' '.join(response.css('div.post-content p::text').extract())
